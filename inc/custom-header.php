...
function inspiro_custom_header_setup()
{
	...
	register_default_headers(
		array(
			'default-image' => array(
				'url'           => '%s/assets/images/hero-default.jpg',
				'thumbnail_url' => '%s/assets/images/hero-default-thumb.jpg',
...
?>
		<style id="inspiro-custom-header-styles">
			...
			if ('blank' === $header_text_color) : ?>.site-title,
			.site-description {
				position: absolute;
			...
			<?php endif; ?><?php if ('' !== $hero_color_only_hero_title) : ?>.site-title a,
			...
			<?php endif; ?><?php if ('#ffffff' !== $color_menu_search_icon_btn) : ?>.sb-search .sb-search-button-open .sb-icon-search .svg-icon,
			.sb-search .sb-search-button-close .sb-icon-search .svg-icon {
				fill: <?php echo $color_menu_search_icon_btn; ?>;
			}

			<?php endif; ?><?php if ('#ffffff' !== $color_menu_hamburger_btn) : ?>.navbar-toggle .icon-bar {
				background: <?php echo $color_menu_hamburger_btn; ?>;
			}

			<?php endif; ?><?php if ('#ffffff' !== $color_header_custom_logo_text && inspiro_get_theme_mod('custom_logo_text') !== '') : ?>a.custom-logo-text {
				color: <?php echo $color_header_custom_logo_text; ?>;
			}

			<?php endif; ?><?php if ('' !== $color_header_custom_logo_hover_text) : ?>a.custom-logo-text:hover {
				color: <?php echo $color_header_custom_logo_hover_text; ?>;
			}

			<?php endif; ?><?php if ('' !== $color_navbar_menu_background) : ?>.primary-menu-wrapper {
			...
			/* hero section */
			<?php if ('' !== $color_scroll_to_content_arrow) : ?>#scroll-to-content:before {
				border-color: <?php echo $color_scroll_to_content_arrow; ?>;
			}

			<?php endif; ?><?php if ('' !== $hero_gradient_opacity_control) : ?>.has-header-image .custom-header-media:before {
			...
			/* content */
			<?php if ('' !== $color_general_link_content) : ?>.entry-content a:not(.wp-element-button),
			.entry-summary a,
			.comment-content a,
			.posts-navigation a {
			...
			<?php endif; ?><?php if ('' !== $color_general_link_hover_content) : ?>.entry-content a:not(.wp-element-button):hover,
			...
			<?php endif; ?><?php if ('' !== $color_general_underline_text) : ?>.entry-content a:not(.wp-element-button),
			.entry-summary a,
			.comment-content a,
			.posts-navigation a {
			...
			/* sidebar */
			<?php if ('#101010' !== $color_sidebar_widgets_background) : ?>.side-nav__scrollable-container {
				background: <?php echo $color_sidebar_widgets_background; ?>;
			}

			<?php endif; ?><?php if ('#78787f' !== $color_sidebar_widgets_text) : ?>.side-nav__scrollable-container {
				color: <?php echo $color_sidebar_widgets_text; ?>;
			}

			<?php endif; ?><?php if ('#ffffff' !== $color_sidebar_widgets_title) : ?>.side-nav h2.wp-block-heading,
			.side-nav .widget .title {
				color: <?php echo $color_sidebar_widgets_title; ?>;
			}

			<?php endif; ?><?php if ('#0bb4aa' !== $color_sidebar_widgets_link) : ?>:root :where(.side-nav__wrap a:where(:not(.wp-element-button))) {
			...
			/* footer */
			<?php if ('#101010' !== $color_footer_background) : ?>.site-footer {
			...
			<?php endif; ?><?php if ('#ffffff' !== $color_footer_copyright_text) : ?>.site-footer .copyright span:first-child {
			...
			/* general */
			<?php if ('' !== $color_general_h_tags) : ?>h1,
			h2,
			h3,
			h4,
			h5,
			...
			<?php endif; ?><?php if ('' !== $color_general_h1_tag) : ?>h1 {
				color: <?php echo $color_general_h1_tag; ?>;
			}

			<?php endif; ?><?php if ('' !== $color_general_h2_tag) : ?>h2 {
				color: <?php echo $color_general_h2_tag; ?>;
			}

			<?php endif; ?><?php if ('' !== $color_general_h3_tag) : ?>h3 {
				color: <?php echo $color_general_h3_tag; ?>;
			}

			<?php endif; ?><?php if ('' !== $color_general_h4_tag) : ?>h4 {
				color: <?php echo $color_general_h4_tag; ?>;
			}

			<?php endif; ?><?php if ('' !== $color_general_h5_tag) : ?>h5 {
				color: <?php echo $color_general_h5_tag; ?>;
			}

			<?php endif; ?><?php if ('' !== $color_general_h6_tag) : ?>h6 {
				color: <?php echo $color_general_h6_tag; ?>;
			}

			<?php endif; ?><?php if ('' !== $color_general_page_title) : ?>.page .entry-title,
			.page.colors-dark .entry-title,
			.page.colors-custom .entry-title {
				color: <?php echo $color_general_page_title; ?>;
			}

			<?php endif; ?><?php if ('' !== $color_general_post_title) : ?>.single-post .entry-title,
			.single-post.colors-dark .entry-title,
			.single-post.colors-custom .entry-title {
				color: <?php echo $color_general_post_title; ?>;
			}

			<?php endif; ?><?php if ('' !== $color_general_entry_excerpt_text) : ?>.entry-summary>p {
				color: <?php echo $color_general_entry_excerpt_text; ?>;
			}

			<?php endif; ?><?php if ('' !== $color_general_entry_content_text) : ?>.entry-content {
