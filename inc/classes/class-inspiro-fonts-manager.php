	...
	class Inspiro_Fonts_Manager
	{
		...
		public static function render_fonts()
		{
			...
			if ($enable_local_google_fonts && ! $wp_customizer) {
				wp_enqueue_style('inspiro-google-fonts', $local_google_fonts_url, array(), LOGOVO_THEME_VERSION, 'all');
			} else {
				wp_enqueue_style('inspiro-google-fonts', self::$google_font_url, array(), LOGOVO_THEME_VERSION, 'all');
			}
		}
