...
if (! class_exists('Inspiro_Customizer')) {
	...
	class Inspiro_Customizer
	{
		...
		public function register_control_types($wp_customize)
		{
			...
			require LOGOVO_THEME_DIR . 'inc/customizer/customizer-controls.php';
			...
			foreach ($configuration_files as $folder_name => $files) {
				foreach ($files as $file_name) {
					...
					if (! class_exists($class_name)) {
						if (file_exists(LOGOVO_THEME_DIR . "inc/customizer/configs/{$folder_name}/class-inspiro-{$file_name}-config.php")) {
							require LOGOVO_THEME_DIR . "inc/customizer/configs/{$folder_name}/class-inspiro-{$file_name}-config.php";
